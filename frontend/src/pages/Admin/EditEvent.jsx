  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Object.keys(form).forEach((key) => {
        if (key !== "image" && form[key] !== undefined) {
      ...
      <div className="w-full max-w-6xl bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20">
        ...
        >
          ...
          <div className="space-y-5">
            {/* IMAGE */}
            <div>
              <label className="text-gray-300 text-sm">Event Image</label>
            ...
            <div className="flex gap-3 pt-2">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 py-2 rounded-xl bg-gradient-to-r from-pink-500 to-indigo-500 hover:scale-105 transition shadow-lg disabled:opacity-50"
              >
